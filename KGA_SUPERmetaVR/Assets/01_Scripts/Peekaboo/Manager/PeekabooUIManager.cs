...
public class PeekabooUIManager : OnlyOneSceneSingleton<PeekabooUIManager>
{
    ...
    private void Start()
    {
        ...
        //gameResultUI = PeekabooGameManager.Instance.PlayerPrefeb.GetComponentInChildren<GameObject>();
        //playerRankingText = PeekabooGameManager.Instance.PlayerPrefeb.GetComponentInChildren<TextMeshProUGUI>();
        //totalPlayerCount = PeekabooGameManager.Instance.PlayerPrefeb.GetComponentInChildren<TextMeshProUGUI>();
        //surprisedEnemyNumbersText = PeekabooGameManager.Instance.PlayerPrefeb.GetComponentInChildren<TextMeshProUGUI>();
        //survivalTimeText = PeekabooGameManager.Instance.PlayerPrefeb.GetComponentInChildren<TextMeshProUGUI>();
        //NumberOfCoinsAcquiredText = PeekabooGameManager.Instance.PlayerPrefeb.GetComponentInChildren<TextMeshProUGUI>();
        //watchingButton = PeekabooGameManager.Instance.PlayerPrefeb.GetComponentInChildren<Button>();
    }
    private void Update()
    {
